            ...
            <ul className="m-0 inline-flex h-7 rounded-md bg-[#6e76811a] p-0 text-sm">
              ...
              <li className="relative my-[-1px] mr-[1px] block grow">
                <Tooltip
                  ...
                  className="left-[-10%_!important]"
                >
                  <Link className="file-action-left-btn" href="#">
                    <span className="flex h-full items-center justify-center rounded-md border border-transparent bg-transparent px-3 hover:bg-[#30363d]">
                      <div>Blame</div>
                    </span>
                  </Link>
                </Tooltip>
          ...
          <div className="mr-2 flex items-center gap-2">
            <div className="flex gap-2">
              <div className="isolate inline-flex align-middle">
                ...
                <Tooltip text={isTextCopied ? 'Copied!' : 'Copy raw file'}>
                  <button
                    onClick={onCopy}
                ...
                <Tooltip text="Disabled for demo">
